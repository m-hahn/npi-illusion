...
critical[0].push({s: "The "+topNouns[nouns[0]]+" that the principal who the teacher liked left was quoted in the newspaper.", a:"x-x-x imposes soul ago involving glad holy instead chest cent medal lake brooks let camp involving."})
...
critical[7].push({s: "The "+topNouns[nouns[7]]+" that the mobster who the media portrayed disappeared turned out to be true.", a:"x-x-x realizes slow hear agrees oh cent which footsteps trip importantly summer week cup sick rate."})
...
critical[13].push({s: "The "+topNouns[nouns[13]]+" that the victims who the criminal assaulted survived calmed everyone down.", a:"x-x-x derives yeah wow connect lake mid continue accessing sort animation duplex standing ha."})
...
critical[19].push({s: "The "+topNouns[nouns[19]]+" that the CEO who the employee impressed retired was entirely correct.", a:"x-x-x befriends lord oh Ms ways okay annoying ancestors okay scissors send agencies command."})
